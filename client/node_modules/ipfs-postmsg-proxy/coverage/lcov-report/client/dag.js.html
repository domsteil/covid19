...
<html lang="en">
<head>
    <title>Code coverage report for client/dag.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">client</a> dag.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (args[1] &amp;&amp; args[1].cid) {
<span class="cstat-no" title="statement not covered" >            if (isBuffer(args[1].cid)) {</span>
<span class="cstat-no" title="statement not covered" >              args[1].cid = bufferToJson(args[1].cid)</span>
            } else <span class="cstat-no" title="statement not covered" >if (isCid(args[1].cid)) {</span>
<span class="cstat-no" title="statement not covered" >              args[1].cid = cidToJson(args[1].cid)</span>
            }
          }
&nbsp;
          return args
...
&nbsp;
            ...
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (res.value) { // TODO: CBOR node, is this correct?
