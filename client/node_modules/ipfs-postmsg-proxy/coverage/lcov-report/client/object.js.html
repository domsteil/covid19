...
<html lang="en">
<head>
    <title>Code coverage report for client/object.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">client</a> object.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >        (</span>res) =&gt; isDagNodeJson(res) ? dagNodeFromJson(res) : res</span>
      )
    ),
...
<span class="cstat-no" title="statement not covered" >          if (args[0] &amp;&amp; isBuffer(args[0].Data)) {</span>
<span class="cstat-no" title="statement not covered" >            args[0] = Object.assign({}, args[0], { Data: bufferToJson(args[0].Data) })</span>
          }
&nbsp;
...
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >          (</span>res) =&gt; res.map(dagLinkFromJson)</span>
        )
      )
    ),
