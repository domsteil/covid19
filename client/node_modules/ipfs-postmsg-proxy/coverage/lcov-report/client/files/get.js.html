...
<html lang="en">
<head>
    <title>Code coverage report for client/files/get.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">client/files</a> get.js
    </h1>
    <div class='clearfix'>
    ...
    getReadableStream () {
      return toStream.source(
        pull(
          ...
          pull.map((file) =&gt; {
            <span class="missing-if-branch" title="else path not taken" >E</span>if (file.content) {
