...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof opts.pre !== 'function') {
...
&nbsp;
  const ipfs = {
    ...
    dns: expose('ipfs.dns', pre(
      opts.pre('dns'),
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      (...args) =&gt; getIpfs().dns(...args)</span></span>
    ), opts),
    ...
    resolve: expose('ipfs.resolve', pre(
      opts.pre('resolve'),
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      (...args) =&gt; getIpfs().resolve(...args)</span></span>
    ), opts),
    ...
    version: expose('ipfs.version', pre(
      opts.pre('version'),
<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >      () =&gt; getIpfs().version()</span></span>
    ), opts)
  }
&nbsp;
  Object.assign(
