    ...
    return (
      <form onSubmit={sendMessage}>
        ...
        <div className="column">
          ...
          <IconButton appearance="minimal" icon="paperclip" />
          <IconButton appearance="minimal" icon="link" />
          <IconButton appearance="minimal" icon="lock" />
          <IconButton appearance="minimal" icon="thumbs-up" />
          </Pane>
          <input
            id="textbox"
