...
class AddPatientWithAccount extends React.Component {
    ...
    render() {
        ...
        <br/>
        <br/>
        <Button className="policyButton" type="submit" onClick={() => toaster.success('Patient ' + this.firstNameRef.current.value + ' ' + this.lastNameRef.current.value + ' has been created ')
      }
      >
...
export default withApollo(AddPatientWithAccount);